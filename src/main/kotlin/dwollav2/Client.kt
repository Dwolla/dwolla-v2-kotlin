...
import dwollav2.api.BusinessClassificationsApi
import dwollav2.api.CustomersApi
import dwollav2.api.DocumentsApi
import dwollav2.exception.DwollaException
import dwollav2.exception.OAuthException
import dwollav2.http.Headers
import dwollav2.http.JsonBody
import dwollav2.http.MultipartBody
import dwollav2.http.Query
import dwollav2.http.Response
import dwollav2.resource.DwollaError
import dwollav2.resource.OAuthError
import dwollav2.util.Deserializer
import dwollav2.util.Token
import dwollav2.util.TokenManager
import dwollav2.util.UrlBuilder
...
class Client(
    ...
    companion object {
        ...
        private val USER_AGENT_HEADER = mapOf("user-agent" to "dwolla-v2-kotlin/0.0.1-pre1")
    }
    ...
    internal var urlBuilder: UrlBuilder = UrlBuilder(this)
